...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive dark:data-[variant=destructive]:focus:bg-destructive data-[variant=destructive]:*:[svg]:text-destructive! focus:bg-foreground focus:text-background relative flex cursor-pointer items-center gap-2 p-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-8 data-[variant=destructive]:focus:text-white [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 data-[variant=destructive]:focus:*:[svg]:text-white!",
        className
      )}
      {...props}
    />
