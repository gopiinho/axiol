      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-6">
          ...
          <div className="space-y-2">
            ...
            <div
              className={cn(
                "bg-card/90 flex h-10 w-full items-center gap-0 rounded-xs border px-2 py-2 text-base transition-[color,box-shadow,transform]",
            ...
            >
              ...
              <input
                ...
                className="placeholder:text-muted-foreground min-w-0 flex-1 border-none bg-transparent p-0 text-base outline-none md:text-sm"
              />
            </div>
          ...
          {productType !== "affiliate" && (
            <div className="space-y-2">
              ...
              />
              <p className="text-muted-foreground text-xs">Optional. Shown on the product card.</p>
            </div>
          )}
        </div>
      </div>
