        ...
        <div className="space-y-10">
          ...
          <Section title="3. Permitted Use">
            ...
            <div className="space-y-2">
              ...
              <Ul>
                ...
                <li>
                  Violate Instagram&apos;s Terms of Use, Community Guidelines,
                  or Platform Policy.
                </li>
                <li>
                  Attempt to circumvent rate limits or other technical
                  safeguards.
                </li>
                <li>
                  Use the Service for illegal activities, fraud, or deceptive
                  practices.
                </li>
                <li>
          ...
          <Section title="4. Instagram Integration">
            <P>
              ...
              . You are solely responsible for the content of automated messages
              sent through your account, including product links and collection
              descriptions.
            </P>
            <P>
          ...
          <Section title="6. Limitation of Liability">
            ...
            <Ul>
              ...
              <li>
                We are not responsible for lost revenue, missed messages, or
                failed automations due to Instagram API changes, downtime, or
                rate limiting.
              </li>
              <li>
          ...
          <Section title="7. Termination">
            <P>
              ...
              prohibited conduct, or if we are required to do so by law. Upon
              termination, we will delete your data in accordance with our
              Privacy Policy.
            </P>
          </Section>
